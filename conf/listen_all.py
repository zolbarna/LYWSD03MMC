...
async def main():
    ...
    def detection_callback(count, device, advertisement_data):
        ...
        print("MAC", atc_mi_data.search("MAC"), end=" ")
        print("temp:", atc_mi_data.search("temperature"), end=" ")
        print("humi:", atc_mi_data.search("humidity"), end=" ")
        print("blvl:", atc_mi_data.search("battery_level"), end=" ")
        print("bv:", atc_mi_data.search("battery_v"), end=" ")
